...
| [exp4](exp4/) | 1.5400 | 1.4334 | 0.8756 | RoPE embeddings + SwiGLU MLP, 8-layer GPT, 8 heads, 256 embd-dim, block size 128, dropout 0.2, trained for one epoch | [text](exp4/generation.txt) | — |
<!-- leaderboard:end -->
